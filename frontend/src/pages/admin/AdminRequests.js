          ...
          {selected && (
            <>
              ...
              <div className="space-y-3 text-sm">
                ...
                {selected.clash_note && <p className="text-amber-700 bg-amber-50 border border-amber-200 rounded p-2 text-xs" data-testid="admin-clash-note">⚠ {selected.clash_note}</p>}
